...
VertexArray::VertexArray() {
    ...
    BE_GL_LOG("GL: glGenVertexArrays(1, {})", m_VertexArray);
}

VertexArray::~VertexArray() {
    BE_GL_LOG("GL: glDeleteVertexArrays(1, {})", m_VertexArray);
    glDeleteVertexArrays(1, &m_VertexArray);
}

void VertexArray::Bind() const {
    glBindVertexArray(m_VertexArray);
    BE_GL_LOG("GL: glBindVertexArray({})", m_VertexArray);
}

void VertexArray::Unbind() const {
    BE_GL_LOG("GL: glBindVertexArray(0)");
    glBindVertexArray(0);
}
    ...
    for (size_t i = 0; i < bufType.Length(); i++) {
        ...
        switch (type.Type) {
            ...
            case ShaderDataType::Float4: {
                BE_GL_LOG(
                    "GL: glVertexAttribPointer({}, {}, GL_FLOAT, {}, {}, {})",
                ...
                BE_GL_LOG("GL: glEnableVertexAttribArray({})",
                          m_VertexBufferIndex);
            ...
            case ShaderDataType::Bool: {
                ...
                BE_GL_LOG("GL: glVertexAttribIPointer({}, {}, {}, {}, {}, {})",
                          m_VertexBufferIndex, element.ComponentCount,
